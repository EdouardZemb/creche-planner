...
- [Revue standards industriels 2026-08](revue-standards-2026-08.md) — plan `.claude/plans/plan-standards-industriels.md` ; **lots 0 → 4 mergés** (doc 37, effacement, bornes, portabilité, RFC 9457) et **lot 5 en PR #319** (validation d'environnement) ; portes `retentions` / `portabilite` / `problemes` / `environnement` ; prochain = **lot 6 piste d'audit acteur (`AM-45`)**.
