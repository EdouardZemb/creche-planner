...
- [Le coût ne ment plus](chantier-cout-ne-ment-plus.md) — chantier validé PO 2026-08-16 ; **lot 1 « la fin d’une version existe » livré (PR #336)** : `foyer_version.date_fin` matérialisée, le coût d’un mois non couvert **refuse** (422) au lieu de rendre 202,88 € faux et muet.
  ⚠️ une garde posée sur « aucune ligne » ne voit rien (l’amont rend toujours une prestation, à quantités nulles), un 4xx déterministe ouvrait le disjoncteur partagé, et deux jeux de test ne passaient que tant que la date du jour le voulait ; restent `AM-88` (purge T1) et `AM-90` (mensualité crèche), deux arbitrages PO.
