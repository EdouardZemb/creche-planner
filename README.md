...
| [ADR](docs/adr/)                                                                                             | 0001 → 0010 : microservices · grain des services & politiques tarifaires · toolchain · décentralisation des contrats · registre de contrats · préférences de notification · **exemption domestique & démarche volontaire** (RGPD) · **écarts de sémantique HTTP** assumés (pagination, concurrence optimiste) · **nom du produit** (« Martha », renommage d'affichage seul) · **données de santé du dossier** : révision de l'exemption domestique, stockage autorisé sous cinq conditions opposables |
