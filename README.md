...
- **portes de conception** — chacune confronte un écrit à son code, avec un
  ...
  `process.env` hors configuration, aucun réglage de compose inerte) et
  `pnpm empechements` ;
