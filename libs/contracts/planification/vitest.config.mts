...
export default defineConfig(() => ({
  root: __dirname,
  cacheDir: '../../../node_modules/.vite/libs/contracts/planification',
  test: {
    name: 'contracts-planification',
    watch: false,
    globals: true,
    environment: 'node',
    ...
    coverage: {
      ...
      // Mesuré 100 % (32/32 lignes, `events` + `etablissement/preavis`) : le
      // contrat est un jeu de schémas zod, tous instanciés par la spec. Seuil
      // posé au mesuré, comme les autres briques partagées (doc 03 §6).
      thresholds: {
        statements: 100,
        branches: 100,
        functions: 100,
