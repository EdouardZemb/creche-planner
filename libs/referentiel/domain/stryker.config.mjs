// AQ-13 (doc 27) — mutation testing du domaine référentiel (catalogue versionné,
// modes de garde, périodes de validité, tranches). Exécution :
// `pnpm nx run referentiel-domain:mutation` (hors CI bloquante, cf.
// .github/workflows/mutation.yml). Seuil `break` aligné sur la cible ≥ 80 %.
...
const config = {
  ...
  // Barrel exclu (réexports purs, aucun code exécutable).
  mutate: ['src/lib/**/*.ts', '!src/**/*.spec.ts'],
