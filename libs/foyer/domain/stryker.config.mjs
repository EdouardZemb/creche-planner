// AQ-13 (doc 27) — mutation testing du domaine foyer (identité du foyer,
// enfants, invariants d'agrégat). Exécution : `pnpm nx run foyer-domain:mutation`
// (hors CI bloquante, cf. .github/workflows/mutation.yml). Seuil `break` aligné
// sur la cible ≥ 80 %.
