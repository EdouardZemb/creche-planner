...
import { TYPES_EVENEMENTS_REFERENTIEL } from '@creche-planner/contracts-referentiel';
...
/** Client de repli muet : jamais sollicité sur les chemins jugés ici. */
const clientMuet = {} as unknown as PlanificationClient;
...
describe('svc-tarification — typesGeres borne les abonnements (AM-53)', () => {
  const projection = new ProjectionService(dbMuette, clientMuet);
