 ...
 * (`MAX_LIVRAISONS`) — plus aucune perte silencieuse (ex. un récap de validation
 * qui ne partirait jamais). Copie **structurelle** du modèle
 * `libs/nest-commons/src/lib/messaging/dead-letter.options.ts` (le typecheck de
