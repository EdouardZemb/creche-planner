...
| [45 — Plan d'implémentation de la prochaine release](45-plan-implementation-prochaine-release.md) | Inventaire du backlog SFD, graphe de dépendances, vagues d'implémentation, règle de coupe                  |
