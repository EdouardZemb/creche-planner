...
> Statut : **Établi** · Version 1.3 · 2026-08-14
...
| **Catégories de données** | Adresse e-mail de l'auteur (ou le nom du service appelant, ou rien quand aucune assertion valide n'a été présentée), nature de l'action, identifiant de la ressource visée, horodatage. **Aucune valeur métier n'y est recopiée.** |
...
| T9    | Piste d'audit acteur (`journal_audit`)                             | **3 ans**                                                             | `journal_audit.cree_le`                                          |  ✅  | Une piste qu'on efface perd ce qui la rend utile — mais elle nomme des personnes, et une donnée personnelle sans durée est ce que ce §3 interdit. 3 ans est la durée déjà assignée aux deux autres traces du même dossier (T1, T1bis) : la piste ne survit pas à ce qu'elle documente. |
